...
/**
 * Exemple molt senzill per utilitzar una classe gràfica per seleccionar fitxers
 * del sistema de fitxers del s.o. showOpenDialog es per seleccionar obrir un
 * fitxer showSaveDialog es per seleccionar gravar a un fitxer
 *
 * @author Montse
 * @version maig 2012
 */
...
//                System.out.println("Primera paraula=" + lectura);
            ...
            if (ok2 != JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    Scanner lectura = new Scanner(fitxerEntrada);
